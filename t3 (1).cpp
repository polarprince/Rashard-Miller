//---------------------------------------------------------------------------
// File name:   Concert Ticket Tracker
// Assign ID:   
// Date Created:    11/15/2023
//
// Purpose:     To display the details for a concert, and keep track of 
//              how many tickets are available utilizing an array where each available
//              cell represents an available ticket. The csv file colllects
//              the name of each customer/user and the amount of tickets they purchased.
//
...
// Fuction for writing to the file
  void ticketListFile(string name, int amountOfTickets){
   ...
   void copyright()
   {
   cout << endl << endl << "(c) 2023, Christopher Miller" << endl; 
   }